...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <style>
      ...
      <meta property="og:title" content="Lawrence Wang">
      <meta property="og:image" content="https://www.50-a.org/images/officer/128/DPW3-lawrence-wang.jpg">
      <meta name="twitter:card" value="summary">
      <meta property="og:description" content="9 allegations, 1 substantiated, 5 lawsuits $147,501">
...
Other: $19436">made $196,000 last year,</span>
        ...
        <span class="taxid">Tax #948283</span>
      </div>
  ...
  <div class="container summary">
    <h2 class="title is-4 complaints"><a name="complaints">Complaints</a></h2>
    <div class="allegations columns">
      <div class="column">
        ...
        <div class="allegations">
          ...
          <span class="name">Allegations</span>
        </div>
        <div class="substantiated">
          <span class="count">1</span>
          <span class="name">Substantiated</span>
        </div>
      </div>
      <div class="dispositions column">
          <div class="disposition">
            <span class="count">1</span>
            <span class="name">Substantiated (Formalized Training)</span>
          </div>
          <div class="disposition">
            <span class="count">1</span>
            <span class="name">Closed - Pending Litigation</span>
          </div>
          <div class="disposition">
            <span class="count">5</span>
            <span class="name">Complainant Uncooperative</span>
          </div>
          <div class="disposition">
            <span class="count">1</span>
            <span class="name">Complaint Withdrawn</span>
          </div>
          <div class="disposition">
            <span class="count">1</span>
            <span class="name">Exonerated</span>
          </div>
      </div>
    </div>
  </div>
  ...
  <div class="container complaints is-hidden-tablet">
    ...
    <div class="complaint">
      ...
      <table class="table is-narrow is-hoverable is-fullwidth">
        ...
        <tr class="complainant">
          <th>Complainant:</th>
          <td>
            Female,&nbsp;<span class="age">30-34</span>
          </td>
        </tr>
        <tr class="disposition">
          <th>CCRB Conclusion:</th>
          <td>Complainant Uncooperative</td>
        </tr>
        <tr class="allegation">
          <th>Allegation:</th>
        ...
        <tr class="allegation">
          <th>Allegation:</th>
          <td>Abuse of Authority: Threat to notify ACS</td>
        </tr>
        <tr class="complainant">
          <th>Complainant:</th>
          <td>
    ...
    <div class="complaint">
      ...
      <table class="table is-narrow is-hoverable is-fullwidth">
        ...
        <tr class="complainant">
          <th>Complainant:</th>
          <td>
            Hispanic&nbsp;Male,&nbsp;<span class="age">23</span>
          </td>
        </tr>
        <tr class="disposition">
          <th>CCRB Conclusion:</th>
    ...
    <div class="complaint">
      ...
      <table class="table is-narrow is-hoverable is-fullwidth">
        ...
        <tr class="complainant">
          <th>Complainant:</th>
          <td>
            Hispanic&nbsp;Female,&nbsp;<span class="age">23</span>
          </td>
        </tr>
        <tr class="disposition">
          <th>CCRB Conclusion:</th>
    ...
    <div class="complaint">
      ...
      <table class="table is-narrow is-hoverable is-fullwidth">
        ...
        <tr class="complainant">
          <th>Complainant:</th>
          <td>
            Black&nbsp;Male,&nbsp;<span class="age">31</span>
          </td>
        </tr>
        <tr class="disposition">
          <th>CCRB Conclusion:</th>
        ...
        <tr class="nypd_penalty penalty_details">
          <th>Penalty:</th>
          <td>Instructions</td>
        </tr>
  ...
  <div class="container complaints is-hidden-mobile">
    <table class="table is-narrow is-hoverable is-fullwidth">
      <tbody>
          <tr class="complaint">
            <th colspan="3">
          ...
          <tr class="header">
            ...
            <td class="disposition">CCRB Conclusion</td>
          </tr>

            <tr class="allegation">
              <td class="allegation">
                Offensive Language: Gender
              </td>
              <td class="complainant">
                Female,&nbsp;<span class="age">30-34</span>
              </td>
              <td class="disposition">Complainant Uncooperative</td>
            </tr>
            ...
            <tr class="allegation">
              <td class="allegation">
                Abuse of Authority: Threat to notify ACS
              </td>
              <td class="complainant">
                Female,&nbsp;<span class="age">30-34</span>
              </td>
          ...
          <tr class="header">
            ...
            <tr class="allegation">
              ...
              <td class="disposition">Closed - Pending Litigation</td>
            </tr>
          ...
          <tr class="header">
            ...
            <tr class="allegation">
              ...
              <td class="disposition">Complaint Withdrawn</td>
            </tr>
          ...
          <tr class="header">
            ...
            <tr class="allegation">
              ...
              <td class="disposition">Substantiated (Formalized Training)</td>
            </tr>
            ...
            <tr class="allegation">
              ...
              <td class="disposition">Exonerated</td>
            </tr>
            ...
            <tr class="nypd_penalty">
              <td class="nypd_penalty" colspan="3">
                <span class="penalty_details">Penalty:</span>
                <span class="nypd_penalty_details penalty_details">Instructions</span>
              </td>
            </tr>
